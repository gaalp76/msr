<?php  
	...
	$message .= '<p>Ezt a levelet azért kapta, mert valaki nevezett a '.$this->BUSS_NAME.' honlapján a '.$competitionName.' versenyre. A versenyen létrehozota a "'.$teamName.'" váltó csapatot. </p>';	
