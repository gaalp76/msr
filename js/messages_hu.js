 ...
 */
 custom_messages = {
	...
	failed_reg_comp: "A nevezés megersősítése sikertelen.",
	failed_reg_comp_email_exists: "Ezzel az email címmel már neveztek.",
	failed_teamamte: "A kód nem szerepel a regisztrációs adatbázisban, vagy nem regisztrált.",
	failed_team_reg: "Ez a csapatnév már foglalt.",
	failed_add_team: "A csapat létrehozása nem sikerült.",

	exist_email: "Az email cím már foglalt!",
	exist_username: "A felhasználónév  már foglalt!",
	
	success_register: "Köszönjük nevezését! A nevezés megerősítéséhez kattintson az email címére elküldött levélben található linkre.",
	success_signup: "Az új felhasználó adatainak mentése megtörtént.",	
	success_login: "Köszöntjük a Honvéd Ezüst Nyíl Sportegyesület Admin felületén!",
	...
	success_reg_confirm: "Regisztráció megerősítve.",
	success_reg_email_send: "Köszönjük regisztrációját! A megadott email címre elküldtük a megerősítő linket.",
	success_reg_comp: "A nevezés megerősítve. A szervezők jóváhagyásáról a megadott email címen értesítjük.",
	...
	warning_username_required: "Kérem adja meg felhasználónevét!",
	...
	confirm_logout_title: "Kijelentkezés",
	confirm_logout_content: "Biztosan ki akar jelentkezni?",
	msg_confirm: "Igen",
	msg_cancel: "Mégsem",
	msg_loading: "Betöltés...",

	attached_documents: "Kapcsolódó dokumentumok"
}
$.extend( $.validator.messages, custom_messages );
