...
class Config {
	...
	public $DATABASE_USERNAME = "njrzhzou_msr"; 
	public $DATABASE_PASSWORD = "MsrUsr2018pw"; //SzMdtaPW218
	public $DATABASE_NAME = "njrzhzou_msr";
	public $MAIL_SENDER = "info@survivalrun.hu";
	public $MAIL_USERNAME = "info@survivalrun.hu";
	public $MAIL_PASSWORD = "surRun18";
	public $MAIL_SMTP = "mail.survivalrun.hu";
	public $SALT = "SZMSZC553334411212";
	public $DAY_REMAINING_TO_VALID = 30;
	public $LOGIN_PROBE = 3;
	public $BASE_URL = "survivalrun.hu";
